...
import checkSvg from './check-fill.svg';
import { MainOfferSVG } from './MainOffer';
import './style.scss';
    ...
    <div className="main-offer-wrapper" style={{ backgroundImage: `url(${png.src})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
      ...
      <div className="vector-wrapper">
        ...
        <div className="offer-wrapper">
          <div className="title main-title">Service</div>
          <div className="title sub-title">to suit your</div>
          ...
          <div className="_mt-10 _flex _gap-6">
            <div className="main-button _cursor-pointer">
              Order online now
            </div>
